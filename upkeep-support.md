...
<p class="policy-intro">
This support page includes help with common questions, reminders, troubleshooting, privacy information, and ways to contact support.
</p>
...
Open the **Tasks** or **Reminders** section in Upkeep, then use the add button to create a new maintenance reminder.

You can add a task title, due date, repeat schedule, notes, and any other useful details.

### How do reminders work?

Upkeep uses local notifications to remind you about upcoming, due-today, and overdue maintenance tasks.

To receive reminders, notifications must be enabled for Upkeep in your iPhone or iPad settings.
...
Make sure notifications are enabled, then choose your preferred alert style.
...
No. Upkeep does not sell your personal information.
